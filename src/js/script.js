...
(function () {
    ...
    function start() {
        ...
        //Screen 3
        screenTimeline.to( qs('.screen-02'), 0, {opacity: 0, delay: 0.5});
        ...
        //Screen 4
        screenTimeline.to( qs('.screen-03-menu'), 0, {opacity: 0, delay: 0.5});
        ...
        screenTimeline.to( qs('.screen-03'), 0, {opacity: 0});
        ...
        //Screen 6
        screenTimeline.to( qs('.screen-04'), 0, {opacity: 0, delay: 0.5});
        screenTimeline.from( qs('.screen-06'), 0, {opacity: 0, y: '25%'});
        screenTimeline.to( qs('.screen-06'), 1, {opacity: 1} );

        //click to open account notes
        screenTimeline.from (qs('.screen-06 .tap-marker'), 0, {opacity: 0, delay: 1.5});
        screenTimeline.to( qs('.screen-06 .tap-marker'), 0.25, {opacity: 0.8, scale: 0.7, delay: 0.5});
        screenTimeline.to( qs('.screen-06 .tap-marker'), 0.35, {opacity: 0, scale: 1}, '+=0.5');

        //Screen 7
        screenTimeline.to( qs('.screen-06'), 0.5, {opacity: 0, delay: 1.5});
        screenTimeline.to( qs('.screen-07'), 0.5, {opacity: 1});
        screenTimeline.to( qs('.screen-03'), 0, {opacity: 1, delay: 0.5});

        //back to feed
        screenTimeline.from (qs('.screen-07 .tap-marker'), 0, {opacity: 0, delay: 1.5});
        screenTimeline.to( qs('.screen-07 .tap-marker'), 0.25, {opacity: 0.8, scale: 0.7, delay: 0.5});
        screenTimeline.to( qs('.screen-07 .tap-marker'), 0.35, {opacity: 0, scale: 1}, '+=0.5');

        //Screen 7
        screenTimeline.to( qs('.screen-03 .tap-marker'), 0, {opacity: 0});
        screenTimeline.to( qs('.screen-07'), 0.5, {opacity: 0});
        screenTimeline.to( qs('.screen-03'), 0.5, {opacity: 1});
    }
