...
(function () {
    ...
    function start() {
        ...
        screenTimeline.from( qs('.screen-03 .tap-marker'), 0.35, {opacity: 0, delay: 0.5});
        screenTimeline.to( qs('.screen-03 .tap-marker'), 0.25, {scale: 0.7, delay: 0.5});
        screenTimeline.to( qs('.screen-03 .tap-marker'), 0.35, {opacity: 0, scale: 1}, '+=0.5');
        screenTimeline.to( qs('.screen-03'), 1, {delay: 0.5});
